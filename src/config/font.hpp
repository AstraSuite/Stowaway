...
class FontBuilders : public QObject {
    ...
    Q_PROPERTY(stowaway::config::FontBuilder extraLarge READ extraLarge NOTIFY buildersChanged FINAL)
    Q_PROPERTY(stowaway::config::FontBuilder large READ large NOTIFY buildersChanged FINAL)
    Q_PROPERTY(stowaway::config::FontBuilder medium READ medium NOTIFY buildersChanged FINAL)
    Q_PROPERTY(stowaway::config::FontBuilder small READ small NOTIFY buildersChanged FINAL)
...
class FontStyleBase : public QObject {
    ...
    Q_PROPERTY(stowaway::config::FontBuilders* builders READ builders CONSTANT FINAL)
...
public:
    ...
    Q_INVOKABLE stowaway::config::FontBuilder size(int pointSize);
};
...
class FontTokens : public QObject {
    ...
    Q_PROPERTY(stowaway::config::FontStyle* headline READ headline CONSTANT FINAL)
    Q_PROPERTY(stowaway::config::FontStyle* title READ title CONSTANT FINAL)
    Q_PROPERTY(stowaway::config::FontStyle* body READ body CONSTANT FINAL)
    Q_PROPERTY(stowaway::config::FontStyle* label READ label CONSTANT FINAL)
    Q_PROPERTY(stowaway::config::FontStyle* mono READ mono CONSTANT FINAL)
    Q_PROPERTY(stowaway::config::IconFontStyle* icon READ icon CONSTANT FINAL)
