...
class ColoursSingleton : public QObject {
    ...
    Q_PROPERTY(stowaway::config::M3Palette* palette READ palette CONSTANT)
...
public:
    ...
    static ColoursSingleton* instance();
    static ColoursSingleton* create(QQmlEngine* = nullptr, QJSEngine* = nullptr) {
        auto* inst = instance();
