...
class AnimCurves : public QObject {
    ...
    Q_PROPERTY(stowaway::config::AnimDurationTokens* durations READ durations CONSTANT)
...
class TokensSingleton : public QObject {
    ...
    Q_PROPERTY(stowaway::config::RoundingTokens* rounding READ rounding CONSTANT)
    Q_PROPERTY(stowaway::config::SpacingTokens* spacing READ spacing CONSTANT)
